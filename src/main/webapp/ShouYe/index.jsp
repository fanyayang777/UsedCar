...
<div class="banner">
    ...
    <div class="menu_r">
        <div class="flexslider">
            <ul class="slides">
                <li style="background-image:url(images/0.jpg);"></li>
    ...
    <div class="newslist">
        <div class="nKe">
            ...
            <div class="slide">
                ...
                <div class="bd">
                    <ul>
                        <li >
                            <div class="bd-dl"> <a href="newsinfor.jsp" class="aImg"> <img src="images/car2.jpg" /> </a>
                                <div class="joininfor">
                                    <h4>当漂移车手  遇见限量A8</h4>
                            ...
                            <div class="bd-dl"> <a href="newsinfor.jsp" class="aImg"> <img src="images/car2.jpg" /> </a>
                                <div class="joininfor">
                                    ...
                                    <div align="right"> <a href="newsinfor.jsp" class="cMore">查看详情</a> </div>
                                </div>
                            </div>
                        </li>
                        <li >
        ...
        <div class="r-news">
            ...
            <div class="r-news-list">
                <ul>
                    <li><span class="date">11月02日</span><i class="icon "></i><a href="newsinfor.jsp" title="龙城易贷网贷10月份月报"> 龙城易贷网贷10月份月报 </a> </li>
                    <li><span class="date">10月10日</span><i class="icon "></i><a href="newsinfor.jsp" title="龙城易贷网贷9月份月报"> 龙城易贷网贷9月份月报 </a> </li>
                    <li><span class="date">09月28日</span><i class="icon "></i><a href="newsinfor.jsp" title="关于2016年国庆节放假工作安排的通知"> 关于2016年国庆节放假工作安... </a> </li>
                    <li><span class="date">09月13日</span><i class="icon "></i><a href="newsinfor.jsp" title="关于2016年中秋节放假工作安排的通知"> 关于2016年中秋节放假工作安... </a> </li>
                    <li><span class="date">09月13日</span><i class="icon "></i><a href="newsinfor.jsp" title="关于2016年中秋节放假工作安排的通知"> 关于2016年中秋节放假工作安... </a> </li>
                </ul>
            </div>
        </div>
